...
public class TrolladafinalModItems {
	...
	public static final RegistryObject<Item> ZOIOBOSS_SPAWN_EGG = REGISTRY.register("zoioboss_spawn_egg", () -> new ForgeSpawnEggItem(TrolladafinalModEntities.ZOIOBOSS, -16777114, -256, new Item.Properties()));
