...
public class TrolladafinalModItems {
	...
	public static final RegistryObject<Item> ZOIO_FINAL_SPAWN_EGG = REGISTRY.register("zoio_final_spawn_egg", () -> new ForgeSpawnEggItem(TrolladafinalModEntities.ZOIO_FINAL, -1, -1, new Item.Properties()));
	...
	public static final RegistryObject<Item> ALEK_SPAWN_EGG = REGISTRY.register("alek_spawn_egg", () -> new ForgeSpawnEggItem(TrolladafinalModEntities.ALEK, -10066330, -10990540, new Item.Properties()));
	public static final RegistryObject<Item> ALEK_ANIMATED_SPAWN_EGG = REGISTRY.register("alek_animated_spawn_egg", () -> new ForgeSpawnEggItem(TrolladafinalModEntities.ALEK_ANIMATED, -1, -1, new Item.Properties()));
