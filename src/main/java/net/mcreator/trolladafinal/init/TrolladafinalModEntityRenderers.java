...
import net.mcreator.trolladafinal.client.renderer.ZoioFinalRenderer;
import net.mcreator.trolladafinal.client.renderer.ZoioBossRenderer;
import net.mcreator.trolladafinal.client.renderer.AlekRenderer;
...
public class TrolladafinalModEntityRenderers {
	...
	public static void registerEntityRenderers(EntityRenderersEvent.RegisterRenderers event) {
		...
		event.registerEntityRenderer(TrolladafinalModEntities.ZOIO_FINAL.get(), ZoioFinalRenderer::new);
		event.registerEntityRenderer(TrolladafinalModEntities.ALEK.get(), AlekRenderer::new);
